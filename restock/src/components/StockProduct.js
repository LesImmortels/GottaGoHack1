...
function StockProduct({ name, price, link, quantity, demand}) {
    ...
    return (
        <tr className="even:bg-gray-100">
            ...
            <th className="px-6 align-middle border border-solid py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap text-left">{demand}</th>
            ...
            <th className="px-6 align-middle border border-solid py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap text-left"><button onClick={() => removeStock()} className="mx-2 w-5 h-5bg-white border-gray-500 border rounded-full">
