...
function Sidebar() {
    ...
    return (
        <>
            {currentUser && (
                <div className="bg-gradient-to-tr font-semibold from-black to-darkG text-gray-200 pl-16 pr-20 py-16 lg:w-3/12 h-screen">
                        ...
                        <ul className="space-y-4 font-semibold">
                            ...
                            <li>
                                ...
                                >
                                    ...
                                    <p className="underline-animation cursor-pointer">Stock</p>
                                </Link>
                            </li>
                            <li>
                                <Link
                                ...
                                >
                                    <svg
                                        ...
                                        xmlns="http://www.w3.org/2000/svg"
                                    >
                                        <path d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z" fillRule="evenodd" />
                                    </svg>
                                    <p className="underline-animation cursor-pointer">Sales</p>
                                </Link>
                            </li>
                            <li>
                                <Link
                                ...
                                >
                                    ...
                                    <p className="underline-animation cursor-pointer">Orders</p>
                                </Link>
                            </li>
                            <li>
                                <Link
                                ...
                                >
                                    ...
                                    <p className="underline-animation cursor-pointer">Settings</p>
                                </Link>
                            </li>
                        </ul>
                    )}
